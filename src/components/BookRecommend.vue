<template>
  <div id='form-wrapper'>
    ...
    <h3 style='letter-spacing:0.07em;margin:30px 0px;'>あなたのおすすめ本</h3>
...
export default {
  ...
  data() {
    ...
    cont_types: [{ text: 'みんなに知らせたい！', value: 'news'}, { text: 'これ欲しい！', value: 'shopping'}],
    id_last: '0',
    post_message: false,
  ...
  methods: {
    ...
    sample(){
      //コメント記入した本のオブジェクトをアラートする
      window.alert(this.$store.state.books);
